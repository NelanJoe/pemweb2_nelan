    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-3">
            <div class="col-lg-4 mb-5">
                <!-- Form -->
                <form method="POST" action="script-php/post-nilai-siswa.php"
                    class="w-100 p-4 rounded-3 shadow-lg border border-dark border-2">
                    <div class="mb-3">
                        <label>Nama</label>
                    ...
                    <div class="mb-3">
                        <button type="submit" class="btn btn-primary text-uppercase w-100 " name="proses"
